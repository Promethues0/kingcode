...
- Delegate to subagent only for a self-contained investigation whose conclusion is all you need back — it cannot nest, and it returns text, not edits. Make the edits yourself.
